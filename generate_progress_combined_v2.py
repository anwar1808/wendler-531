...
def bezier_dip(t1, v1, t2, v2, n=200):
    ...
    # Reduced dip depth by ~60% (multiplied by 0.4) for a subtler arc
    dip_depth = (abs(v2 - v1) * 0.3 + (gap_days / 365.0) * 0.05 * min(v1, v2)) * 0.4
...
out_path = '/Users/annie/Downloads/wendler_progress_combined_v2.png'
